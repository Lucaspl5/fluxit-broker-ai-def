...
export class TechnicalAnalysisService {
  ...
  calculateIndicators(
    ...
    try {
      ...
      // RSI divergence: compare last 5 bars — price lower low but RSI higher low (bullish) and vice versa
  ...
  detectConvergenceSignal(
    ...
    // Multi-timeframe confirmation (bonus points — don't block, but add weight)
