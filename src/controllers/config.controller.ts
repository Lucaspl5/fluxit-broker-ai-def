...
export class ConfigController {
  ...
  @Get(':symbol')
  @ApiOperation({ summary: 'Configuración de un símbolo' })
  ...
  @Post(':symbol')
  @ApiOperation({ summary: 'Crear o actualizar configuración de un símbolo' })
  @ApiParam({ name: 'symbol' })
  ...
  @Post(':symbol/disable')
  @ApiOperation({ summary: 'Deshabilitar monitoreo de un símbolo' })
  @ApiParam({ name: 'symbol' })
